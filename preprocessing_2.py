...
input_inference_norm_dir = input_inference_dir + "Preprocessing/Channels_Normalization/"
input_inference_comp_dir = input_inference_dir + "Preprocessing/Channels_Compression/"
...
def load_ch_param (n_monitors): 
    ...
    for i in range(1,n_monitors+1):
        ...
        data_temp["32"]["M"+str(i)] = open(input_inference_norm_dir + "32_M" + str(i) + ".txt",'r').read().splitlines()
...
def load_ch_comp(n_monitors):
    ...
    for i in range(1,3+1):
        data["32"]["M"+str(i)] = pickle.load(open(input_inference_comp_dir + "32_M"+ str(i)+".pkl", "rb"))
    return data
