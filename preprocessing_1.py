...
def load_ch_param (n_monitors): 
    ...
    for i in range(1,n_monitors+1):
        ...
        data_temp["20"]["M"+str(i)] = open(input_inference_norm_dir + "20_M" + str(i) + ".txt",'r').read().splitlines()
...
def load_ch_comp(n_monitors):
    ...
    for i in range(1,3+1):
        data["20"]["M"+str(i)] = pickle.load(open(input_inference_comp_dir + "20_M"+ str(i)+".pkl", "rb"))
